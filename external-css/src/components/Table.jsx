 ...
 const seatGrp = splitedSeats; 
    ...
    return (
        <div className='table'>
            ...
            <button  className='table__head__remove' onClick={e =>
                ...
                <h3 className='table__head__title'>Stůl: {index+1}</h3>
                <p  className='table__head__sum' >{suma}</p>
               
            </div>
            <div className='table__body' >
                <div className="table__body__seats">{seatGrp}</div>
                <div className='table__body__btns'>
                    <button className='table__body__btns__btn' onClick={e =>
